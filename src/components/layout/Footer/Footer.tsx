        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              ...
              <a href="#" className="text-white hover:text-accent-gold text-sm uppercase transition-colors">Contacto</a>
              <a href="#" className="text-white hover:text-accent-gold text-sm uppercase transition-colors">Ubicaciones</a>
              <a href="#" className="text-white hover:text-accent-gold text-sm uppercase transition-colors">Eventos</a>
              <a href="#" className="text-white hover:text-accent-gold text-sm uppercase transition-colors">Noticias</a>
              <a href="#" className="text-white hover:text-accent-gold text-sm uppercase transition-colors">Contacto</a>
            </div>
